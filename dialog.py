print("Hello! Welcome! Welcome!zz")
name = input("Enter your name:")
funny_fact = input("What is the funny fact about you?")
One_truth_about_you = input("Tell me one truth about you:")
One_lie_about_you = input("Tell me one lie about you:")
color = input("What is your favorite color?")

print(f"Hey {name} How's your day?" )
